...
var EnvValidationSchema = import_zod2.default.object({
  PORT: import_zod2.default.coerce.number().default(3333),
  DATABASE_URL: import_zod2.default.string(),
  OPEN_AI_API_KEY: import_zod2.default.string(),
  OPEN_MODEL: import_zod2.default.string(),
  NODE_ENV: import_zod2.default.enum(["dev", "test", "production"]).default("dev")
});
