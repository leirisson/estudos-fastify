...
export async function transactionsRoutes(app: FastifyInstance) {
    ...
    app.get('/:id', { preHandler: [checkSessionExists] }, async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    app.get('/sumary', { preHandler: [checkSessionExists] }, async (request: FastifyRequest) => {
        const { sessionId } = request.cookies
